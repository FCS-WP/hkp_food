...
$testimonials_json  = wp_json_encode( $testimonials );
?>
...
<div <?php echo $wrapper_attributes; ?> data-testimonials="<?php echo esc_attr( $testimonials_json ); ?>">
    <div class="testimonials__container">
        ...
        <div class="testimonials__content-col"<?php echo $content_style ? ' style="' . esc_attr( $content_style ) . '"' : ''; ?>>
            <?php if ( $heading ) : ?>
                ...
                <div class="testimonials__slider" data-slider>
                    <div class="testimonials__slides">
                        <?php foreach ( $testimonials as $index => $testimonial ) : ?>
                            <div class="testimonials__slide" data-slide="<?php echo esc_attr( (string) $index ); ?>" <?php echo 0 === $index ? 'data-active' : ''; ?>>
                                ...
                                <?php if ( ! empty( $testimonial['rating'] ) ) : ?>
                                    <div class="testimonials__rating">
                                        <?php for ( $i = 1; $i <= 5; $i++ ) : ?>
                                            <span class="testimonials__star <?php echo $i <= (int) $testimonial['rating'] ? 'is-active' : ''; ?>">★</span>
                                        <?php endfor; ?>
                                    </div>
                                <?php endif; ?>
