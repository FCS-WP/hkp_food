...
/**
 * Thank You Page — AI Zippy Child Override
 *
 * Extends parent override to display Chinese Name under product name.
 *
			...
			<div class="az-thankyou__card">
				...
				<div class="az-thankyou__items">
					<?php foreach ($order->get_items() as $item_id => $item) :
						...
						$chinese_name = $product ? (string) get_post_meta($product->get_id(), 'chinese_name', true) : '';
					?>
						<div class="az-thankyou__item">
							...
							<div class="az-thankyou__item-detail">
								...
								<?php if ($chinese_name !== '') : ?>
									<span class="az-thankyou__item-chinese-name"><?php echo esc_html($chinese_name); ?></span>
								<?php endif; ?>
								<?php
